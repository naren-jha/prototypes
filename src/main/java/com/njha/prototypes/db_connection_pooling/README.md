...
### With no db pooling:
- For each db call, we create a new connection, whcih invloves
...
- Performance improvement is not seen in PostgreSQL, probably because of Postgre's internal optimizations.
